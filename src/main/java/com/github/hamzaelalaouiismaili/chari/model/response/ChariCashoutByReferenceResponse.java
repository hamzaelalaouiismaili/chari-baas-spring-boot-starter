...
/**
 * Response DTO for cash-out by reference request.
...
public class ChariCashoutByReferenceResponse {

    private CashoutByReferenceData data;
    ...
    @AllArgsConstructor
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public static class CashoutByReferenceData {
